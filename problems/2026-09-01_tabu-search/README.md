...
**Source**: [https://github.com/TheAlgorithms/Python/blob/master/searches/tabu_search.py](https://github.com/TheAlgorithms/Python/blob/master/searches/tabu_search.py)
**Language**: Python
...
*Automatically fetched on 2026-09-01 17:40:33*
